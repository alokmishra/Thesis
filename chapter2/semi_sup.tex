...
\centering
\subfigure[Section of the image showing significant enrichment]{
\includegraphics[scale=0.5]{/home/alok/phd/post_viva/semisup/results/analysis/img_stress_yt/1.eps}
\label{fig:stress_ppi_enrich_1}
}
\subfigure[Section of the image showing significant enrichment]{
\includegraphics[scale=0.4]{/home/alok/phd/post_viva/semisup/results/analysis/img_stress_yt/2.eps}
\label{fig:stress_ppi_enrich_2}
}
\label{fig:stress_ppi_enrich}
...
nucleic acid bing, rRNAprocessing, RNA processing and RNA metabolic process are few of the common enriched processes observed between Stress and Stress Yeastract. 
...
telomere maintenance, amine metabolic process, orgnic acid metabolic process, oxidoreductase activity, regulation of metabolic process, regulation of trascription. 
Trascription, regulation of cellular process, transcription of regulator activity and biological regulation are the other significant enrichment observed only 
