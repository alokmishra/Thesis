...
We start with the full stress and cell-cycle data-sets from SMD as discussed earlier. It had x genes including NORFs. Since not much is known about the function of NORFs , so we removed all the NORF from the data-sets. 
That left us with x genes in the stress data-set and y genes in the cell-cycle data-sets. They had a and b experiment counts respectively. We created ten perturbed data-sets from each of stress and cell-cycle datasets after 
subsampling (drawing 90\% of the genes randomly). The exact procedure is outlined below

\begin{enumerate}
  
\item We got the full stress and cell-cycle data-sets. It had x genes including NORFs. Since not much is known about the function of NORFs , so we removed all the NORF from the data-sets. That left us with x genes in the stress data-set and y genes in the cell-cycle data-sets. They had a and b experiment counts respectively.
