...
\includegraphics[bb=0 0 720 720,scale=0.18]{/home/alok/phd/post_viva/semisup/spirals/100.eps}
\label{fig:spirals_original}
}
\subfigure[Noisy dataset clustering without any constraints]{
\includegraphics[bb=0 0 720 720,scale=0.18]{/home/alok/phd/post_viva/semisup/spirals/1.eps}
\label{fig:spirals_no_constraints}
}
\subfigure[Noisy dataset clustering with 5 constraints]{
\includegraphics[bb=0 0 720 720,scale=0.18]{/home/alok/phd/post_viva/semisup/spirals/5.eps}
\label{fig:spirals_5_constraints}
}
\subfigure[Noisy dataset clustering with 10 constraints]{
\includegraphics[bb=0 0 720 720,scale=0.18]{/home/alok/phd/post_viva/semisup/spirals/10.eps}
\label{fig:spirals_10_constraints}
}
\subfigure[Noisy dataset clustering with 15 constraints]{
\includegraphics[bb=0 0 720 720,scale=0.18]{/home/alok/phd/post_viva/semisup/spirals/15.eps}
\label{fig:spirals_15_constraints}
}
\subfigure[Noisy dataset clustering with 20 constraints]{
\includegraphics[bb=0 0 720 720,scale=0.18]{/home/alok/phd/post_viva/semisup/spirals/20.eps}
\label{fig:spirals_20_constraints}
}
\subfigure[Noisy dataset clustering with 25 constraints]{
\includegraphics[bb=0 0 720 720,scale=0.18]{/home/alok/phd/post_viva/semisup/spirals/25.eps}
\label{fig:spirals_25_constraints}
}
\subfigure[Noisy dataset clustering with 50 constraints]{
\includegraphics[bb=0 0 720 720,scale=0.18]{/home/alok/phd/post_viva/semisup/spirals/50.eps}
...
\begin{figure}[p]
\centering
\subfigure[Cross Validation Run-1]{
\includegraphics[bb=50 50 410 302,scale=0.5]{/home/alok/phd/post_viva/semisup/spirals/cv_fold1.eps}
\label{fig:spirals_cv_fold1}
}
\subfigure[Cross Validation Run-2]{
\includegraphics[bb=50 50 410 302,scale=0.5]{/home/alok/phd/post_viva/semisup/spirals/cv_fold2.eps}
\label{fig:spirals_cv_fold2}
}
\subfigure[Cross Validation Run-3]{
\includegraphics[bb=50 50 410 302,scale=0.5]{/home/alok/phd/post_viva/semisup/spirals/cv_fold3.eps}
\label{fig:spirals_cv_fold3}
}
\subfigure[Cross Validation Run-4]{
\includegraphics[bb=50 50 410 302,scale=0.5]{/home/alok/phd/post_viva/semisup/spirals/cv_fold4.eps}
\label{fig:spirals_cv_fold4}
}
\subfigure[Cross Validation Run-5]{
\includegraphics[bb=50 50 410 302,scale=0.5]{/home/alok/phd/post_viva/semisup/spirals/cv_fold5.eps}
...
\begin{figure}[tp]
 \centering
 \includegraphics[scale=1.0]{/home/alok/phd/post_viva/semisup/results/plots/stress_dunn.eps}
...
\begin{figure}[tp]
 \centering
 \includegraphics[scale=1.0]{/home/alok/phd/post_viva/semisup/results/plots/stress_davies.eps}
...
\begin{figure}[tp]
 \centering
 \includegraphics[scale=1.0]{/home/alok/phd/post_viva/semisup/results/plots/ccycle_dunn.eps}
...
\begin{figure}[tp]
 \centering
 \includegraphics[scale=1.0]{/home/alok/phd/post_viva/semisup/results/plots/ccycle_davies.eps}
...
\includegraphics[bb=0 0 674 79, scale=0.5]{/home/alok/phd/post_viva/semisup/results/analysis/img_stress_only/1.eps}
\label{fig:stress_only_enrich_1}
}
\subfigure[Section of the image showing significant enrichment]{
\includegraphics[bb=0 0 775 967, scale=0.4]{/home/alok/phd/post_viva/semisup/results/analysis/img_stress_only/2.eps}
...
\centering
\subfigure[Section of the image showing significant enrichment]{
\includegraphics[scale=0.5]{/home/alok/phd/post_viva/semisup/results/analysis/img_stress_ppi/1.eps}
\label{fig:stress_ppi_enrich_1}
}
\subfigure[Section of the image showing significant enrichment]{
\includegraphics[scale=0.4]{/home/alok/phd/post_viva/semisup/results/analysis/img_stress_ppi/2.eps}
...
\centering
\subfigure[Section of the image showing significant enrichment]{
\includegraphics[scale=0.5]{/home/alok/phd/post_viva/semisup/results/analysis/img_stress_chip/1.eps}
\label{fig:stress_chip_enrich_1}
}
\subfigure[Section of the image showing significant enrichment]{
\includegraphics[scale=0.4]{/home/alok/phd/post_viva/semisup/results/analysis/img_stress_chip/2.eps}
...
After the stress dataset and ite integration results we move on to the cell cycle dataset.

\begin{figure}[p]
\centering
\subfigure[Section of the image showing significant enrichment]{
\includegraphics[scale=0.5]{/home/alok/phd/post_viva/ec2machine/semisup/results/analysis/ccycle_only/1.eps}
...
\centering
\subfigure[Section of the image showing significant enrichment]{
\includegraphics[scale=0.5]{/home/alok/phd/post_viva/ec2machine/semisup/results/analysis/ccycle_ppi/1.eps}
\label{fig:ccycle_ppi_enrich_1}
}
\subfigure[Section of the image showing significant enrichment]{
\includegraphics[scale=0.5]{/home/alok/phd/post_viva/ec2machine/semisup/results/analysis/ccycle_ppi/2.eps}
...
\centering
\subfigure[Section of the image showing significant enrichment]{
\includegraphics[scale=0.5]{/home/alok/phd/post_viva/ec2machine/semisup/results/analysis/ccycle_chip/1.eps}
\label{fig:ccycle_ppi_enrich_1}
}
\subfigure[Section of the image showing significant enrichment]{
\includegraphics[scale=0.5]{/home/alok/phd/post_viva/ec2machine/semisup/results/analysis/ccycle_chip/2.eps}
\label{fig:ccycle_ppi_enrich_2}
}
...
The results of mean p-values of all the GO terms' enrichment before and after integration for the stress dataset are shown in Table-\ref{tab:stress:semisup_mean_pvals}. 
...
The results of average p-values of all the GO terms and top 50 terms before and after integration for the cell-cycle dataset are shown in 
Table-\ref{tab:ccycle:semisup_mean_pvals}. If we observe the results of top 50 terms for integration with the DNA-binding dataset, all the integration results have 
improved the score except one (at p=0.005). The results for all terms are not very different even though we observe a very small negative score for p-values 
of 0.0005 and 0.001. The biggest improvements are shown at larger p-values. This is in contrast with the earlier (stress) results where the 
p-values till 0.0005 had performed better, and the larger ones, poorly. 

The reason we had chosen stress and cell-cycle datasets is because they represent two ends of the spectrum \citep{amos05integrative}. A possible explanation of 
