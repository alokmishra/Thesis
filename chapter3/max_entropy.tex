...
\begin{figure}[p]
  \begin{center}
    \subfigure[ChIP-chip $\beta$ optimization using total within-cluster sum of square distances]
            {\label{fig:chip_withinss}\includegraphics[scale=0.7]{images_only/maxent/results/sigmaopt/plots/chip_withinss.eps}}
    \subfigure[PPI $\beta$ optimization using total within-cluster sum of square distances]
            {\label{fig:ppi_withinss}\includegraphics[scale=0.7]{images_only/maxent/results/sigmaopt/plots/ppi_withinss.eps}} \\
    \subfigure[Yeastract $\beta$ optimization using total within-cluster sum of square distances]
            {\label{fig:yt_withinss}\includegraphics[scale=0.7]{images_only/maxent/results/sigmaopt/plots/yt_withinss.eps}}
  \end{center}
